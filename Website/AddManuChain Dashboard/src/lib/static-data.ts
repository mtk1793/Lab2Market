...
export const shipments = [
  { id: 'ship-1', trackingId: 'AMC-001-2024', orderId: 'ord-1', status: 'in_transit', origin: 'Atlantic XL, Halifax NS', destination: "Horizon Maritime, St. John's NL", carrier: 'FedEx Priority', estimatedDelivery: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000).toISOString(), actualDelivery: null, distance: 1150, progress: 65 },
  { id: 'ship-2', trackingId: 'AMC-002-2024', orderId: 'ord-2', status: 'out_for_delivery', origin: 'DNV Calgary, Calgary AB', destination: 'Noble Corp, Edmonton AB', carrier: 'Purolator Express', estimatedDelivery: new Date(Date.now() + 1 * 24 * 60 * 60 * 1000).toISOString(), actualDelivery: null, distance: 300, progress: 90 },
  { id: 'ship-3', trackingId: 'AMC-003-2024', orderId: 'ord-3', status: 'delivered', origin: 'Atlantic XL, Halifax NS', destination: "Equinor, St. John's NL", carrier: 'UPS Ground', estimatedDelivery: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(), actualDelivery: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(), distance: 1150, progress: 100 },
  { id: 'ship-4', trackingId: 'AMC-004-2024', orderId: 'ord-5', status: 'delivered', origin: 'LR Montreal, Montreal QC', destination: 'Cove, Edmonton AB', carrier: 'FedEx Ground', estimatedDelivery: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(), actualDelivery: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(), distance: 3500, progress: 100 },
  { id: 'ship-5', trackingId: 'AMC-005-2024', orderId: 'ord-6', status: 'in_transit', origin: 'Atlantic XL, Halifax NS', destination: "Rosen Maritime, St. John's NL", carrier: 'FedEx Priority', estimatedDelivery: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000).toISOString(), actualDelivery: null, distance: 1150, progress: 45 },
  { id: 'ship-6', trackingId: 'AMC-006-2024', orderId: 'ord-7', status: 'delivered', origin: 'DNV Calgary, Calgary AB', destination: 'Horizon Maritime, Halifax NS', carrier: 'Purolator', estimatedDelivery: new Date(Date.now() - 8 * 24 * 60 * 60 * 1000).toISOString(), actualDelivery: new Date(Date.now() - 8 * 24 * 60 * 60 * 1000).toISOString(), distance: 4500, progress: 100 },
  { id: 'ship-7', trackingId: 'AMC-007-2024', orderId: 'ord-8', status: 'preparing', origin: 'Atlantic XL, Halifax NS', destination: "Equinor, St. John's NL", carrier: 'FedEx Priority', estimatedDelivery: new Date(Date.now() + 4 * 24 * 60 * 60 * 1000).toISOString(), actualDelivery: null, distance: 1150, progress: 10 },
  { id: 'ship-8', trackingId: 'AMC-008-2024', orderId: 'ord-9', status: 'delayed', origin: 'Victoria Marine, Victoria BC', destination: 'Thales, Ottawa ON', carrier: 'Canada Post', estimatedDelivery: new Date(Date.now() + 3 * 24 * 60 * 60 * 1000).toISOString(), actualDelivery: null, distance: 4500, progress: 35 },
]
