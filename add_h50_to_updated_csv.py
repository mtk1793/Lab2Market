...
# Load the updated hypothesis CSV file
file_path = '/Users/admin/Library/CloudStorage/OneDrive-DalhousieUniversity/Google Drive/PhD/Lab2Market/Hypothesis/Hypotheses_Updated_Feb1_2026.csv'
df = pd.read_csv(file_path)

# Define the new hypotheses H50-H53
new_hypotheses = [
    {
...
print(f"✅ Added H50-H53 to: {file_path}")
print(f"\nTotal hypotheses: {len(df_updated)} (was {len(df)})")
